...
const OtpVerification = ({ onSubmit, formData, onChange, loading, error, onNavigate, successMessage, onResendOtp }) => (
    <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="text-center mb-8">
            <h2 className={styles.typography.headings.h2}>Reset Password</h2>
            <p className={cn(styles.typography.body.small, "mt-2")}>
                Enter your new password and the 6-digit code sent to your email
            </p>
        </div>
